...
from layers.deeplob_encoder import Deeplob_encoder,Deeplob_encoder_simple
import torch
...
class DeepLOB_TCN(nn.Module):
    def __init__(self, model_config,num_classes: int = 1):
        ...
        # 1. 特征编码器（你的原有模型）
        self.encoder = Deeplob_encoder_simple()
        ...
        self.tcn = TemporalConvNet(num_channels[0], num_channels[1:], kernel_size=3, dropout=0.2)
